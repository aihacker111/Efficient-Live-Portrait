...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--video', '--video_path_or_webcam_id', type=str, required=True,
    ...
    main(args.video_path_or_webcam_id, args.source_img, args.use_tensorrt, args.half_precision, args.real_time)
