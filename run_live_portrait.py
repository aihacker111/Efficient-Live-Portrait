...
def main(video_path, source_img, ref_img, max_faces, use_tensorrt, real_time, half_precision, use_face_id):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-num', '--max_faces', type=int, default=1, required=True, help='Enter number of faces you want to extract in Video Motion')
    ...
    main(args.video, args.image, args.ref_image, args.max_faces, args.run_time, args.real_time, args.half_precision, args.use_face_id)
