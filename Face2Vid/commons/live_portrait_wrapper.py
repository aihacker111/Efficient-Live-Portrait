...
class LivePortraitWrapper(object):
    ...
    def __init__(self, cfg: InferenceConfig):
        ...
        # init W
        self.warping_module = load_model(cfg.checkpoint_W, model_config, cfg.device, 'warping_module')
        log(f'Load warping_module done.')
        # init G
        self.spade_generator = load_model(cfg.checkpoint_G, model_config, cfg.device, 'spade_generator')
